module EvtModule
  ...
  use SimVariablesModule, only: iout  !added by Liya for debug
  !
  implicit none
  !
  private
...
! ------------------------------------------------------------------------------
    ...
    packobj%ncolbnd = 5 ! Modified by Liya
...
! ------------------------------------------------------------------------------
    ...
    !
    write(this%iout, *) 'SURFACE', this%bound(1, 1)
    write(this%iout, *) 'RATE', this%bound(2, 1)
    write(this%iout, *) 'DEPTH', this%bound(3, 1)
    write(this%iout, *) 'K_et', this%bound(4, 1)
    write(this%iout, *) 'n_et', this%bound(5, 1)
    
    
    write(this%iout, *) 'SURFACE size', size(this%bound(1, :))
	write(this%iout, *) 'RATE size', size(this%bound(2, :))
    write(this%iout, *) 'DEPTH size', size(this%bound(3, :))
	write(this%iout, *) 'K_et size', size(this%bound(4, :))
    write(this%iout, *) 'n_et size', size(this%bound(5, :))   
    write(this%iout, *) 'this-bound size', size(this%bound)
    write(this%iout, *) 'this-nbound', this%nbound
    write(this%iout, *) 'this-bound ', this%bound
    ...
    do i = 1, this%nbound
      ...
      if (this%ibound(node) > 0 .and. this%ibound(node) /= 10000) then
        ...
        K_et = this%bound(4, i) ! K_et -- by liya
        n_et = this%bound(5, i) ! n_et -- by liya
        !write(this%iout, *) 'RATE', c
        !write(this%iout, *) 'i', i
        h = this%xnew(node)
        if (this%surfratespecified) then
        ...
        if (h >= s) then
          ...
          if (d < x) then
            ...
            !write(iout, *) 'Original'
            !write(iout, *) 'trhs', trhs
            !write(iout, *) 'thcof', thcof
            write(this%iout, *) 'Original'
            write(this%iout, *) 'trhs', trhs
            write(this%iout, *) 'thcof', thcof           
            
            trhs = 0
            thcof = -((K_et * c)*(1 - d/x) ** n_et) / h
            write(this%iout, *) 'Modified'
            write(this%iout, *) 'trhs', trhs
            write(this%iout, *) 'thcof', thcof
            
            write(this%iout, *) 'rhs', this%rhs(i)
            write(this%iout, *) 'hcof', this%hcof(i)
...
! ------------------------------------------------------------------------------
    ...
    character(len=32), dimension(8) :: aname
